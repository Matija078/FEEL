...
function hentOversettelse(sprak, elementId) {
  var oversettelser = {
    no: {
      ...
      heroTekst:
        'Vi leverer skreddersydde webdesignløsninger som er tilgjengelige for alle.',
      produkterOverskrift: 'Våre produkter',
      forstorOverskrift: 'Forstør/minsk tekst',
      forstorTekst:
        'Her kan du legge til tekst og eventuelt implementere funksjonalitet for å forstørre eller forminske tekststørrelsen.',
      sprak: 'Endre språk',
      footerTekst:
    ...
    en: {
      ...
      heroTekst:
        'We deliver customized web design solutions accessible to everyone.',
      produkterOverskrift: 'Our Products',
      forstorOverskrift: 'Enlarge/Reduce Text',
      forstorTekst:
        'Here you can add text and optionally implement functionality to enlarge or reduce the text size.',
      sprak: 'Change Language',
      footerTekst:
        '&copy; 2023 Change Language - Example. All rights reserved.',
    ...
    fr: {
      ...
      heroTekst:
        'Nous proposons des solutions de conception Web personnalisées accessibles à tous.',
      produkterOverskrift: 'Nos produits',
      forstorOverskrift: 'Agrandir/Réduire le texte',
      forstorTekst:
        'Ici, vous pouvez ajouter du texte et éventuellement implémenter une fonctionnalité pour agrandir ou réduire la taille du texte.',
      sprak: 'Changer de langue',
      footerTekst:
        '&copy; 2023 Changer de langue - Exemple. Tous droits réservés.',
    ...
    me: {
      heroOverskrift: 'Dobrodošli na Promijeni Jezik - Primjer',
      heroTekst:
        'Isporučujemo prilagođena web dizajn rješenja koja su dostupna svima.',
      produkterOverskrift: 'Naši proizvodi',
      forstorOverskrift: 'Povećaj/Smanji tekst',
      forstorTekst:
        'Ovdje možete dodati tekst i opcionalno implementirati funkcionalnost za povećavanje ili smanjivanje veličine teksta.',
      sprak: 'Promijeni jezik',
      footerTekst: '&copy; 2023 Promijeni Jezik - Primjer. Sva prava zadržana.',
      'forstor-knapp': 'Povećaj',
      'forminsk-knapp': 'Smanji',
      seVareProdukter: 'Pogledaj naše proizvode',
      nettsideWordpress: 'Web stranica u Wordpressu',
      driftNettside: 'Održavanje web stranice',
...
function endreTekstStorrelse(endring) {
  ...
  var currentFontSize = window
    .getComputedStyle(tekstForstorElement)
